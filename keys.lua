...
keys.globalkeys = gears.table.join(
    ...
    awful.key({}, 'XF86MonBrightnessUp',
        function()
            awful.spawn('light -s sysfs/backlight/intel_backlight -A 10')
    ...
    awful.key({}, 'XF86MonBrightnessDown',
        function()
            awful.spawn('light -s sysfs/backlight/intel_backlight -U 10')
            if toggleBriOSD ~= nil then
                toggleBriOSD(true)
            end
            if UpdateBrOSD ~= nil then
    ...
    awful.key({ modkey }, "h",
       function()
        ...
        {description = "deacrease tag width", group = "tag"}
    ),
    awful.key({ modkey }, "l",
       function()
          awful.tag.incmwfact(0.05)
        end,
        {description = "increase tag width", group = "tag"}
    ),
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ modkey }, "o",
       function(c)
        ...
        {description = "Send client to other screen", group = "tag"}
    ),
