...
local function launch(args)
    ...
    local onlock = args.onlock or function() awful.spawn.with_shell("i3lock -c 35233c") end
    local onreboot = args.onreboot or function() awful.spawn.with_shell("reboot") end
    local onsuspend = args.onsuspend or function() awful.spawn.with_shell("i3lock -c 35233c & systemctl suspend") end
