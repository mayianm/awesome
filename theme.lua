...
theme.taglist_bg_occupied = '#46dfea3A'
theme.taglist_bg_urgent = '#E91E6399'
theme.taglist_bg_focus = '#80dd3e5A'
...
theme.layout_tileleft = "~/.config/awesome/icons/layouts/view-quilt-left.png"
theme.layout_tiletop = "~/.config/awesome/icons/layouts/view-quilt-rot.png"
